# SED_REPLACE_THIS_TITLE - Pull Request
...
3. Proper **label** - Select the `type:` label that best describes the changes
    - Use [one of the **commit types** from this list](https://github.com/rwaight/SED_REPLACE_THIS_REPO/blob/main/commitlint.config.js).
